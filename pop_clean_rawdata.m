...
if nargin < 2
    ...
    uilist =    {...
        ...
        ...
        {} {'style' 'checkbox' 'string' 'Remove irrecoverable portions of data' 'fontweight' 'bold' 'value' 1 'tag' 'rejwin' 'callback' cb_rej } ...
        {} {'style' 'text' 'tag' 'asrwintext' 'string' 'Acceptable channels power [min max] in std. dev.'  'userdata' 'rej'} ...
        ...
        {} {'style' 'text' 'tag' 'asrwintext' 'string' 'Maximum channels out of range (%)'  'userdata' 'rej'} ...
