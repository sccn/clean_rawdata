...
if nargin < 2
    ...
    uilist =    {...
        ...
        ...
        {} {'style' 'checkbox' 'string' 'Max acceptable channel std dev (uV)' 'value' 1 'tag' 'rmnoise' 'userdata' 'chan' } ...
        ...
        {} {'style' 'text' 'string' sprintf('Max acceptable  %1.1f sec window +/- std dev (uV)', winsize) 'value' 1  'userdata' 'asr' } ...
        ...
        {} {'style' 'checkbox' 'tag' 'asrrej' 'string' 'Remove bad data periods (instead of correcting them)'  'userdata' 'asr'} {} ...
        ...
